...
- [ ] Display list of tasks (title, checkbox)
- [ ] "Add Task" floating button → navigates to form
- [ ] Tap checkbox toggles done state
- [ ] Tap task row → edit screen

### 1.3 Task Form Screen
- [ ] Single text input: title (required)
